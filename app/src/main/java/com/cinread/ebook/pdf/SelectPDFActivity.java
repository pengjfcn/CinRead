...
public class SelectPDFActivity extends ListActivity {
    ...
    private static Map<String, Integer> mPositions = new HashMap<String, Integer>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPurpose = PICK_KEY_FILE.equals(getIntent().getAction()) ? Purpose.PickKeyFile : Purpose
                .PickPDF;
        ...
        adapter = new SelectPDFAdapter(getLayoutInflater());
        ...
        mUpdateFiles = new Runnable() {
            public void run() {
                ...
                adapter.clear();
                if (mParent != null)
                    adapter.add(new SelectPDFItem(SelectPDFItem.Type.PARENT, getString(R.string.parent_directory)));
                for (File f : mDirs)
                    adapter.add(new SelectPDFItem(SelectPDFItem.Type.DIR, f.getName()));
                for (File f : mFiles)
                    adapter.add(new SelectPDFItem(SelectPDFItem.Type.DOC, f.getName()));
//                for (File f : mFiles)
//                    adapter.add(new SelectPDFItem(SelectPDFItem.Type.IMG, f.getName()));
                lastPosition();
            }
        };
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if(path.endsWith("txt")){
            Toast.makeText(SelectPDFActivity.this, "PickTXT " + path, Toast.LENGTH_SHORT).show();
            ...
            switch (mPurpose) {
                case PickPDF:
                    Toast.makeText(SelectPDFActivity.this, "PickPDF", Toast.LENGTH_SHORT).show();
