...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport, View
    ...
    public void onClick(View v) {
        ...
        if (v == mInkBack) {
            ...
            Toast.makeText(MuPDFActivity.this, "清空", Toast.LENGTH_SHORT).show();
            if (pageView != null) {
        ...
        //所以要在一个事件中分开考虑问题，需要分开处理，通过设置模式
        switch (mAcceptMode) {
            case Highlight:
                LogUtils.d(TAG, "Highlight");
                break;
            case Underline:
                LogUtils.d(TAG, "Underline");
                break;
            case StrikeOut:
                LogUtils.d(TAG, "StrikeOut");
                break;
            case Ink:
                LogUtils.d(TAG, "Ink");
                switch (v.getId()) {
                    case R.id.backButton:
                        Toast.makeText(MuPDFActivity.this, "Ink-back", Toast.LENGTH_SHORT).show();
                        //TODO 绘制 -- 回退
                        break;
                    case R.id.forwardButton:
                        Toast.makeText(MuPDFActivity.this, "Ink-forward", Toast.LENGTH_SHORT)
                                .show();
                        //TODO 绘制 -- 前进
                        break;
                    case R.id.colorButton:
                        Toast.makeText(MuPDFActivity.this, "Ink-color", Toast.LENGTH_SHORT).show();
                        //TODO 绘制 -- 颜色
                        break;
                    default:
                        break;
                ...
                break;
            case CopyText:
                LogUtils.d(TAG, "CopyText");
                switch (v.getId()) {
                    case R.id.backButton:
                        Toast.makeText(MuPDFActivity.this, "CopyText-back", Toast.LENGTH_SHORT)
                                .show();
                        //TODO 复制文本
                        break;
                    case R.id.forwardButton:
                        Toast.makeText(MuPDFActivity.this, "CopyText-forward", Toast.LENGTH_SHORT)
                                .show();
                        break;
                    case R.id.colorButton:
                        Toast.makeText(MuPDFActivity.this, "CopyText-color", Toast.LENGTH_SHORT)
                                .show();
                        break;
                    default:
                        break;
    ...
    private TextView        mTimeNumberView;
    ...
    public void createUI(Bundle savedInstanceState) {
        ...
        mDocView = new MuPDFReaderView(this) {
            ...
            protected void onMoveToChild(int i) {
                ...
                mPageNumberView.setText(String.format("%d / %d", i + 1,
                        core.countPages()));
                //TODO 可以将seekbar换成自己想要的ViewAnimator
        ...
        mInkBack.setOnClickListener(this);
        mInkForward.setOnClickListener(this);
        mInkColor.setOnClickListener(this);
        mInkBold.setOnClickListener(this);
        mInkClear.setOnClickListener(this);
        //注释  添加 增加的按钮点击事件
        ...
        if (!mButtonsVisible) {
            ...
            anim.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation animation) {
                    ...
                    mTimeNumberView.setVisibility(View.VISIBLE);
                }
            });
        ...
        if (mButtonsVisible) {
            ...
            anim.setAnimationListener(new Animation.AnimationListener() {
                public void onAnimationStart(Animation animation) {
                    ...
                    mTimeNumberView.setVisibility(View.INVISIBLE);
                }
    ...
    private void makeButtonsView() {
        ...
        //注释 添加va
        mViewAnimator = (ViewAnimator) mButtonsView.findViewById(R.id.lowerButton);
        mViewAnimator.setVisibility(View.INVISIBLE);
        mInkBack = (ImageButton) mButtonsView.findViewById(R.id.ink_btn_back);
        ...
        mInkClear = (ImageButton) mButtonsView.findViewById(R.id.ink_btn_clear);
        ...
        mForwardButton = (ImageButton) mButtonsView.findViewById(R.id.forwardButton);
        ...
        //注释  系统时间
        mTimeNumberView = (TextView) mButtonsView.findViewById(R.id.timeNumber);
    ...
    public void proofWithResolution(int resolution) {
        LogUtils.d(TAG, "proofWithResolution: ");
    ...
    public void OnProofButtonClick(final View v) {
        LogUtils.d(TAG, "OnProofButtonClick: ");
    ...
    public void OnSepsButtonClick(final View v) {
        LogUtils.d(TAG, "OnSepsButtonClick: ");
        if (isProofing()) {
    ...
    public void OnCancelAcceptButtonClick(View v) {
        //注释 添加va  TODO 动画效果
        mViewAnimator.setVisibility(View.INVISIBLE);
        LogUtils.d(TAG, "OnCancelAcceptButtonClick: ");
        MuPDFView pageView = (MuPDFView) mDocView.getDisplayedView();
        if (pageView != null) {
            pageView.deselectText();
            pageView.cancelDraw();
        }
        mDocView.setMode(MuPDFReaderView.Mode.Viewing); //注释 回到观察者模式
        switch (mAcceptMode) {
            case CopyText:
                mTopBarMode = TopBarMode.More;
                LogUtils.d(TAG, "CopyText: TopBarMode.More");
                break;
            default:
                mTopBarMode = TopBarMode.Annot;
                LogUtils.d(TAG, "default: TopBarMode.Annot");
                mPageSlider.setVisibility(View.VISIBLE);
                break;
        }
        mTopBarSwitcher.setDisplayedChild(mTopBarMode.ordinal());
