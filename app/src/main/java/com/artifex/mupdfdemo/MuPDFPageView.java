...
public class MuPDFPageView extends PageView implements MuPDFView {
	...
	public MuPDFPageView(Context c, FilePicker.FilePickerSupport filePickerSupport, MuPDFCore
			core, Point parentSize, Bitmap sharedHqBm) {
		...
		LayoutInflater inflater = (LayoutInflater) c.getSystemService(Context
		...
		mSigningDialogBuilder.setNegativeButton(R.string.cancel, new DialogInterface
				.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				dialog.dismiss();
	...
	private void invokeTextDialog(String text) {
		...
		mTextEntry.getWindow().setSoftInputMode(WindowManager.LayoutParams
	...
	public boolean saveDraw() {
		...
		mAddInk = new AsyncTask<PointF[][],Void,Void>() {
			...
			protected Void doInBackground(PointF[][]... params) {
				...
				LogUtils.d(TAG,"doInBackground " + mPageNumber);
				return null;
			}
...
//	}
	...
	@Override
	protected CancellableTaskDefinition<Void, Void> getDrawPageTask(final Bitmap bm, final int
			sizeX, final int sizeY,
																	final int patchX, final int
																				patchY, final int
																				patchWidth, final
																		int patchHeight) {
	...
	protected CancellableTaskDefinition<Void, Void> getUpdatePageTask(final Bitmap bm, final int
			sizeX, final int sizeY,
																	  final int patchX, final int
																			  patchY, final int
																			  patchWidth, final
